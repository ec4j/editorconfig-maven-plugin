 ...
 */
public class FormatParserListener implements XmlParserListener {
    ...
    public FormatParserListener(Resource file, ResourceProperties options, ViolationHandler violationHandler) {
        super();
        this.file = file;
    ...
    private void flushWs() {
        ...
        for (int i = len - 1; i >= 0; i--) {
            ...
            default:
                /*
                 * No end of line foundIndent in the trailing whitespace. Leave the foundIndent from previous ignorable
